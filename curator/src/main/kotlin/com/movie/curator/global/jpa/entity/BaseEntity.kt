package com.movie.curator.global.jpa.entity
...
/**
 * 모든 애그리게이트의 공통 베이스 클래스.
 *  - Long 타입 자동 증가 id
 *  - createdAt / updatedAt 자동 감사 (애플리케이션에 @EnableJpaAuditing 필요)
 *  - soft-delete를 위한 deleted 플래그
 *
 * soft-delete가 필요한 경우 리포지토리는 `deleted = false` 조건으로 필터링한다
 * (예: AnswerRepository의 ...AndDeletedFalse 파생 쿼리).
 */
@MappedSuperclass
